...
def topic_filter(user_input: str) -> bool:
    ...
    # 2. Check if input contains any allowed banking-related topics
    # We use a simple keyword check for this lab
    if any(allowed in input_lower for allowed in ALLOWED_TOPICS):
        return False

    # 3. If no banking topics found, it is off-topic
    return True
        ...
        *,
        ...
        if detect_injection(text):
            ...
            return self._block_response(
                "Security alert: Prompt injection detected. Your request has been blocked."
            )
        ...
        if topic_filter(text):
            self.blocked_count += 1
            return self._block_response(
                "I'm sorry, I can only help with banking-related questions. How can I assist you with your finances today?"
            )
